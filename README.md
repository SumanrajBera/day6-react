...
- Designed a clean data flow where contact data is processed and sent before resetting the form state.
- Focused on React fundamentals such as state management, event handling, and predictable UI behavior.